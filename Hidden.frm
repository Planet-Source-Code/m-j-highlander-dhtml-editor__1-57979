...
sColor = FormatRGBString(cdlgColor.Color)

If Me.Tag = "forecolor" Then
    MainForm.DHTMLEdit1.ExecCommand DECMD_SETFORECOLOR, OLECMDEXECOPT_DONTPROMPTUSER, sColor
Else
    MainForm.DHTMLEdit1.ExecCommand DECMD_SETBACKCOLOR, OLECMDEXECOPT_DONTPROMPTUSER, sColor
End If
...
sColor = ga_ColorVals(Index).ColorName
